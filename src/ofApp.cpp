...
void ofApp::setupAnimations(){
	...
	pts.push_back(array<glm::vec2, 2> {{glm::vec2(fixedWidth/2.0, 860 + projectorOffsetY), glm::vec2(540, 860 + projectorOffsetY)}});
	pts.push_back(array<glm::vec2, 2> {{glm::vec2(540, 860 + projectorOffsetY), glm::vec2(540, 1060 + projectorOffsetY)}});
	pts.push_back(array<glm::vec2, 2> {{glm::vec2(540, 1060 + projectorOffsetY), glm::vec2(1370, 1060 + projectorOffsetY)}});
	pts.push_back(array<glm::vec2, 2> {{glm::vec2(1370, 1060 + projectorOffsetY), glm::vec2(1370, 860 + projectorOffsetY)}});
	pts.push_back(array<glm::vec2, 2> {{glm::vec2(1370, 860 + projectorOffsetY), glm::vec2(fixedWidth/2.0, 860 + projectorOffsetY)}});
	companiesLine = DashedLine(pts, 5.0, red, 250, false);
	pts.clear();
	// the dashed line to the left hand marker
	pts.push_back(array<glm::vec2, 2> {{glm::vec2(fixedWidth/2.0, 860 + projectorOffsetY), glm::vec2(fixedWidth/2.0, 750 + projectorOffsetY)}});
	pts.push_back(array<glm::vec2, 2> {{glm::vec2(fixedWidth/2.0, 750 + projectorOffsetY), glm::vec2(60, 750 + projectorOffsetY)}});
	pts.push_back(array<glm::vec2, 2> {{glm::vec2(60, 750 + projectorOffsetY), glm::vec2(60, 625 + projectorOffsetY)}});
	...
	companiesAnimation = ImageAnimation(
		companies,
		glm::vec2(fixedWidth/2.0, fixedHeight - 120 + projectorOffsetY),
		glm::vec2(800, 184),
		250
	);
	...
	planeMovement = ImageMovement(
		plane,
		glm::vec2(300, 95),
		glm::vec2(-300, -100 + projectorOffsetY),
		glm::vec2(250, 370 + projectorOffsetY),
		250
	);
	shipMovement = ImageMovement(
		ship,
		glm::vec2(300, 113),
		glm::vec2(2000, 800 + projectorOffsetY),
		glm::vec2(1725, 700 + projectorOffsetY),
		250
	);
	/**
	...
	milleniumFalconText = TextTyping(
		...
		glm::vec2(310, 925 + projectorOffsetY),
		ofColor(255),
		8,
		250
	);
	companiesCenterText = TextTyping(
		...
		glm::vec2(fixedWidth/2.0, 800 + projectorOffsetY),
		ofColor(255),
		8,
		250
	);
	companiesRightText = TextTyping(
		...
		glm::vec2(1510, 950 + projectorOffsetY),
		ofColor(255),
		8,
		250
	);
	centerLeftText = TextTyping(
		...
		glm::vec2(225, 670 + projectorOffsetY),
		ofColor(255),
		8,
		250
	);
	buildingLeftText = TextTyping(
		...
		glm::vec2(690, 650 + projectorOffsetY),
		ofColor(255),
		8,
		250
	);
	buildingRightText = TextTyping(
		...
		glm::vec2(1180, 700 + projectorOffsetY),
		ofColor(255),
		8,
		250
	);
	planeText = TextTyping(
		...
		glm::vec2(250, 530 + projectorOffsetY),
		ofColor(255),
		8,
		250
	);
	shipText = TextTyping(
		...
		glm::vec2(1490, 940 + projectorOffsetY),
		ofColor(255),
		8,
		250
	);
	 ...
	 */
	// MILLENIUM FALCON
	handMarkers[0] = HandMarker(glm::vec2(60, fixedHeight - 100 + projectorOffsetY), red, true);
	// CENTER OF THE COMPANIES
	handMarkers[1] = HandMarker(glm::vec2(fixedWidth/2.0 + 40, fixedHeight - 115 + projectorOffsetY), red, false);
	// RIGHT OF THE COMPANIES
	handMarkers[2] = HandMarker(glm::vec2(fixedWidth/3.0 * 2.0 + 60, fixedHeight - 185 + projectorOffsetY), red, false);
	// LEFT OF THE SCREEN
	handMarkers[3] = HandMarker(glm::vec2(60, fixedHeight/2.0 + 80 + projectorOffsetY), red, true);
	// THE LEFT BUILDING
	handMarkers[4] = HandMarker(glm::vec2(510, 550 + projectorOffsetY), red, true);
	// THE RIGHT BUILDING
	handMarkers[5] = HandMarker(glm::vec2(1100, 530 + projectorOffsetY), red, true);
	// THE SHIP
	handMarkers[6] = HandMarker(glm::vec2(1705, 720 + projectorOffsetY), red, true);
	// THE AIRPLANE
	handMarkers[7] = HandMarker(glm::vec2(250, 390 + projectorOffsetY), red, true);
}
...
void ofApp::drawBackground(){
	...
	for (int i = 0; i < 2; i++) {
		ofDrawRectangle(fixedWidth/3.0 * (i + 1) - 1, 0 + projectorOffsetY, 2, fixedHeight);
		float divConst = 5.0;
		if (i == 0) {
			ofDrawRectangle(0, fixedHeight/divConst + projectorOffsetY, fixedWidth, 2);
		} else {
			ofDrawRectangle(0, fixedHeight - fixedHeight/divConst + projectorOffsetY, fixedWidth, 2);
		}
	}
	ofPopStyle();
	background.draw(0, 0 + projectorOffsetY, fixedWidth, fixedHeight);
}
